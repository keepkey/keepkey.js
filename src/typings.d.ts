...
// This is lifted from @types/w3c-web-usb because their  onconnect and ondisconnect
...
declare class USB extends EventTarget {
  ...
  addEventListener (type: 'connect' | 'disconnect', listener: (ev: USBConnectionEvent) => any, useCapture?: boolean): void
}
